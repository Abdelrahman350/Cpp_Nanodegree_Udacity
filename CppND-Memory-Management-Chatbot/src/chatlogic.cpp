...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            // Create unique pointer to specific graph node
    ...
    // Instead of creating Chatbot on heap, we create a local instance on stack.
    ChatBot ChatBotInstance = ChatBot("../images/chatbot.png");

    // Add pointer to chatlogic object so that chatbot answers can be passed on to the GUI
    ...
    // Move chatbot object to the node
